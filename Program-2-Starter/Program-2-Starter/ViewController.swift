...
class ViewController: UIViewController , ColorTableViewControllerDelegate{
    ...
    @IBOutlet weak var ColorSwatcheOne: UIView?
    @IBOutlet weak var ColorSwatcheTwo: UIView?
    @IBOutlet weak var ColorSwatcheThree: UIView!
    @IBOutlet weak var ColorSwatcheFour: UIView!
    @IBOutlet weak var ColorSwatcheFive: UIView!
    @IBOutlet weak var ColorSwatcheSix: UIView!
    @IBOutlet weak var ColorSwatcheSeven: UIView!
    @IBOutlet weak var ColorSwatcheEight: UIView!
    @IBOutlet weak var ColorSwatcheNine: UIView!
    @IBOutlet weak var ColorSwatcheTen: UIView!
    ...
    func ColorTableViewChooseColor(controller: ColorTableViewController, chosenColor color: String){
        ...
        UpdateLabelHistory(labelColor)
        
        println(labelColor)
    }
    
    func UpdateLabelHistory(labelColor: UIColor){
        
        ColorSwatcheTen?.backgroundColor = ColorSwatcheNine?.backgroundColor
        ColorSwatcheNine?.backgroundColor = ColorSwatcheEight?.backgroundColor
        ColorSwatcheEight?.backgroundColor = ColorSwatcheSeven?.backgroundColor
        ColorSwatcheSeven?.backgroundColor = ColorSwatcheSix?.backgroundColor
        ColorSwatcheSix?.backgroundColor = ColorSwatcheFive?.backgroundColor
        ColorSwatcheFive?.backgroundColor = ColorSwatcheFour?.backgroundColor
        ColorSwatcheFour?.backgroundColor = ColorSwatcheThree?.backgroundColor
        ColorSwatcheThree?.backgroundColor = ColorSwatcheTwo?.backgroundColor
        ColorSwatcheTwo?.backgroundColor = ColorSwatcheOne?.backgroundColor
        ColorSwatcheOne?.backgroundColor = labelColor
    }
