...
class ColorTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let labelColor:UIColor = myColors.hexStringToUIColor(myColors.fetchHexValue(color.colorName))
        
        //cell.backgroundColor = labelColor
        
        //cell.imageView?.backgroundColor = labelColor
        //cell.contentView.imageView?.backgroundColor = labelColor
        cell.contentView.backgroundColor = labelColor
